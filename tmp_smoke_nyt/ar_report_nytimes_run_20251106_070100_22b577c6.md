...
![5D Trust Heatmap](./output/heatmap_run_20251106_070100_22b577c6.png)

![Content Type Breakdown](./output/content_type_pie_run_20251106_070100_22b577c6.png)
...
| Field | Value |
|-------|-------|
| **Run ID** | `run_20251106_070100_22b577c6` |
| **Generated** | 2025-11-06T07:01:31.708159 |
| **Items Analyzed** | 6 |
...
| Resonance | 0.706 | 0.453 | 0.846 | 0.180 |
...
- Immediate (1-7 days):
  - Increase transparency score to 0.68 (Δ 0.10)
  - Address the 1 low Trust (inauthentic) item
  
- Short-term (1-4 weeks):
  - Improve overall Trust average to 0.7
  - Increase share labeled 'Authentic' to 70%
  
- Medium (4-12 weeks):
  - Review and address suspect classification item
  - Work towards a more balanced classification distribution

### Success Metrics

- Increase transparency score by 0.10 within 4-12 weeks
- Ensure 66.67% of items are labeled 'Authentic' within 1-4 weeks
- Reduce inauthentic items to 0 within 1-7 days
- Maintain distribution of 'authentic' items at 4 within 1-4 weeks
