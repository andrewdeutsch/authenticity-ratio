...
| **Resonance** | 0.743 | 🟡 Good | Authentic audience engagement |

---

### Key Insights

Analysis of 6 brand-related content items reveals trust patterns across five dimensions. **Resonance** is the strongest dimension (0.743), while **Transparency** (0.576) requires attention. The low transparency scores indicate missing disclosure tags or ambiguous authorship.
...
![5D Trust Heatmap](./output/heatmap_run_20251106_064923_3367db78.png)

![Content Type Breakdown](./output/content_type_pie_run_20251106_064923_3367db78.png)
...
| Field | Value |
|-------|-------|
| **Run ID** | `run_20251106_064923_3367db78` |
| **Generated** | 2025-11-06T06:49:53.754584 |
| **Items Analyzed** | 6 |
...
| Resonance | 0.743 | 0.500 | 0.846 | 0.125 |
...
- Increase transparency score to 0.68 within 4-12 weeks
- Increase overall Trust average to 0.70 within 1-4 weeks
- Ensure 66.67% of shares are labeled 'Authentic' within 1-7 days
- Reduce low Trust (inauthentic) items to 0 within 4-12 weeks
- Increase 'authentic' items to 5 within 1-4 weeks
...
- **Trust Assessment**: High Trust — weaker signals in Transparency, Provenance; strongest: Coherence
- **Visited URL**: https://www.youtube.com/@nytimes
- **Trust Level**: High Trust
- **Rationale**: Low signals in Transparency, Provenance contributed to the lower assessment. Stronger signal in Coherence partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.
