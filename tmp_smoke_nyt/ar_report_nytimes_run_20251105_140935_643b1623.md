...
| **Resonance** | 0.698 | 🟡 Good | Authentic audience engagement |

---

### Key Insights

Analysis of 6 brand-related content items reveals trust patterns across five dimensions. **Verification** is the strongest dimension (0.698), while **Transparency** (0.576) requires attention. The low transparency scores indicate missing disclosure tags or ambiguous authorship.
...
![5D Trust Heatmap](./output/heatmap_run_20251105_140935_643b1623.png)

![Content Type Breakdown](./output/content_type_pie_run_20251105_140935_643b1623.png)
...
| Field | Value |
|-------|-------|
| **Run ID** | `run_20251105_140935_643b1623` |
| **Generated** | 2025-11-05T14:10:04.337751 |
| **Items Analyzed** | 6 |
...
| Resonance | 0.698 | 0.452 | 0.846 | 0.173 |
...
|-------------|-------|------------|---------|
| **High Trust** | 4 | 66.7% | ✅ Strengthens brand |
| **Moderate Trust** | 1 | 16.7% | ⚠️ Needs verification |
| **Low Trust** | 1 | 16.7% | ❌ Requires attention |
...
1. **Immediate (1-7 days)**:
   - Focus on transparency dimension improvements
...
- Improve Transparency dimension score by 0.10+ points
...
This appendix lists all 6 analyzed items with detailed diagnostics including source, title, description, visited URL, final score, and rationale.

### What’s the New York Times Cutoff?

- **Source**: Reddit
- **Title**: What’s the New York Times Cutoff?
- **Trust Assessment**: High Trust rating based on score of 23.19. Weaker dimensions: Provenance (0.14), Transparency (0.14). Strongest: Resonance (0.45).
- **Visited URL**: https://www.reddit.com/r/RunNYC/comments/1onapfn/whats_the_new_york_times_cutoff/
- **Score**: 23.19 | **Trust Level**: Low Trust
- **Rationale**: Low signals in Provenance (0.14), Transparency (0.14) contributed to the lower score. The site lacks visible Terms/Privacy links which reduces trust signals. Missing open-graph metadata reduced the detectable content richness.
...
- **Trust Assessment**: High Trust rating based on score of 85.24. Weaker dimensions: Transparency (0.78), Resonance (0.80). Strongest: Verification (0.99).
- **Visited URL**: https://www.nytimes.com/
- **Score**: 85.24 | **Trust Level**: High Trust
- **Rationale**: Low signals in Transparency (0.78), Resonance (0.80) contributed to the lower score. Strong Verification signal (0.99) partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.
...
- **Trust Assessment**: High Trust rating based on score of 75.93. Weaker dimensions: Verification (0.67), Transparency (0.68). Strongest: Coherence (0.89).
- **Visited URL**: https://www.nytco.com/
- **Score**: 75.93 | **Trust Level**: High Trust
- **Rationale**: Low signals in Verification (0.67), Transparency (0.68) contributed to the lower score. Strong Coherence signal (0.89) partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.

---

### Games | The New York Times Company

- **Source**: Brave
- **Title**: Games | The New York Times Company
- **Trust Assessment**: High Trust rating based on score of 78.11. Weaker dimensions: Transparency (0.68), Provenance (0.71). Strongest: Verification (0.93).
- **Visited URL**: https://www.nytco.com/games/
- **Score**: 78.11 | **Trust Level**: High Trust
- **Rationale**: Low signals in Transparency (0.68), Provenance (0.71) contributed to the lower score. Strong Verification signal (0.93) partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.
...
- **Trust Assessment**: High Trust rating based on score of 76.71. Weaker dimensions: Transparency (0.68), Provenance (0.71). Strongest: Verification (0.86).
- **Visited URL**: https://www.youtube.com/@nytimes
- **Score**: 76.71 | **Trust Level**: High Trust
- **Rationale**: Low signals in Transparency (0.68), Provenance (0.71) contributed to the lower score. Strong Verification signal (0.86) partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.
...
- **Trust Assessment**: High Trust rating based on score of 50.00. Weaker dimensions: Provenance (0.50), Resonance (0.50). Strongest: Provenance (0.50).
- **Visited URL**: Not available
- **Score**: 50.00 | **Trust Level**: Moderate Trust
- **Rationale**: Low signals in Provenance (0.50), Resonance (0.50) contributed to the lower score. The site lacks visible Terms/Privacy links which reduces trust signals. Missing open-graph metadata reduced the detectable content richness. LLM classified this item as suspect (conf=0.6).
