...
|-----------|---------------|--------|-------------|
| **Provenance** | 0.633 | 🟡 Good | Content traceability and source verification |
| **Verification** | 0.698 | 🟡 Good | Alignment with authoritative brand data |
| **Transparency** | 0.576 | 🟠 Moderate | Clarity of ownership and disclosure |
| **Coherence** | 0.672 | 🟡 Good | Consistency with brand messaging |
| **Resonance** | 0.714 | 🟡 Good | Authentic audience engagement |

---

### Key Insights

Analysis of 6 brand-related content items reveals trust patterns across five dimensions. **Resonance** is the strongest dimension (0.714), while **Transparency** (0.576) requires attention. The low transparency scores indicate missing disclosure tags or ambiguous authorship.
...
![5D Trust Heatmap](./output/heatmap_run_20251106_063752_88e43de9.png)

![Content Type Breakdown](./output/content_type_pie_run_20251106_063752_88e43de9.png)
...
| Field | Value |
|-------|-------|
| **Run ID** | `run_20251106_063752_88e43de9` |
| **Generated** | 2025-11-06T06:38:29.536933 |
| **Items Analyzed** | 6 |
...
|-----------|---------|-----|-----|---------|
| Provenance | 0.633 | 0.140 | 0.814 | 0.271 |
| Verification | 0.698 | 0.240 | 0.987 | 0.287 |
| Transparency | 0.576 | 0.140 | 0.778 | 0.232 |
| Coherence | 0.672 | 0.186 | 0.886 | 0.277 |
| Resonance | 0.714 | 0.453 | 0.846 | 0.186 |

### Dimension Performance

**Provenance** (🟡 Good): Origin clarity, traceability, and metadata completeness
...
- Raise Transparency dimension from 0.58 to >= 0.68 (Δ 0.10)
- Increase Core AR (Authentic items %) from 66.7% to >= 76.7%
- Reduce Low Trust (Inauthentic) items by ~25% (≈ 1 fewer items)
- Achieve an overall Trust Stack average >= 0.60 within 90 days
...
- **Trust Assessment**: High Trust — weaker signals in Transparency, Coherence; strongest: Verification
- **Visited URL**: https://www.nytco.com/press/
- **Trust Level**: High Trust
- **Rationale**: Low signals in Transparency, Coherence contributed to the lower assessment. Stronger signal in Verification partially offset weaknesses. Missing open-graph metadata reduced the detectable content richness.
